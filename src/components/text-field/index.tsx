  ...
  return (
    <div className={`${className} mb-4`}>
      ...
      <div className="flex-1">
        <input
          className={`w-full appearance-none py-4 rounded-lg px-4 block shadow-none ring-primary ring-1 placeholder:text-xs bg-pure-white text-xs text-dark focus-within:outline-none focus:outline-none"  ${
